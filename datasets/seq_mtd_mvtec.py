...
def get_mtd_mvtec_dataloaders(
    ...
    if t == 0:
        ...
        if args.model.method == "revdis":
            ...
            test_data = RevDisTestMVTecDataset(
                args.data_dir, task_mvtec_classes, size=args.dataset.image_size
            )
        else:
            train_data = MVTecAD(
                args.data_dir,
...
def get_joint_mtd_mvtec_dataloaders(
    ...
    train_data = MVTecMTDjoint(
        args.data_dir, args.mtd_dir, args.dataset.image_size, transform=train_transform
    )
    test_data = MVTecMTDjoint(
        args.data_dir,
        args.mtd_dir,
        args.dataset.image_size,
        transform=test_transform,
